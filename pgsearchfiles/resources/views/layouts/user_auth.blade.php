...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Enrollspace.com | User Login</title>
        ...
        <link href="{{ asset('assets/admin/global/css/components-md.min.css') }}" rel="stylesheet" id="style_components" type="text/css" />
        <link href="{{ asset('assets/admin/global/css/plugins-md.min.css') }}" rel="stylesheet" type="text/css" />

        <link href="{{ asset('assets/admin/pages/css/login-5.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- END HEAD -->
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <img class="login-logo login-6" src="{{ asset('assets/images/logo-wide-white.png') }}" />
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Developed at <a href="http://www.webcomindia.biz/" target='_blank'>WebCom</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ asset('assets/admin/global/plugins/backstretch/jquery.backstretch.min.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{ asset('assets/admin/global/scripts/app.min.js') }}" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{ asset('assets/admin/pages/scripts/login-5.js') }}" type="text/javascript"></script>
